...
def mov_avg(sma_win_o, sma_win_c, ema_win_o, ema_win_c, data):
    ################################ SMA ################################
...
def objective(trial):
    ...
    print()
    print(f'Value for SMA_Open = {sma_o_tr} EMA_Open = {ema_o_tr}  CNTRL_VAL = {CNTRL_VAL}')
...
class Trader:
    ...
    def prep_data(self, sma_o_tr, ema_o_tr, CNTRL_VAL):
...
pass_data = t.prep_data(study.best_params['sma_o_tr'], study.best_params['ema_o_tr'], study.best_params['CNTRL_VAL'])
